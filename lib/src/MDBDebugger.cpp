...
MDBThread *
MDBDebugger::findThread(thread_t thread) {
...
/**
 * Update MDBThreads with MACH info.
 */
bool 
MDBDebugger::gatherThreads() {
...
bool
MDBDebugger::commitThread(MDBThread *thread) {
...
bool 
MDBDebugger::updateThread(MDBThread *thread) {
